...
public class Quizs {
	...
	public Qcm[] quizQcm() {
		Qcm [] quiz_All = {
<<<<<<< Updated upstream
	    		new Qcm("Quel le type par d̩faut de 3.75 ","int","double","float","short","double"),
=======
...
<<<<<<< Updated upstream
	    		new Qcm("<html> Combien de string cr̩es dans le code suivant ?" +
	    				"<br> String s = \"abc\";\n" + 
...
<<<<<<< Updated upstream
	            new Qcm("<html >La m̩thode qui affiche la liste des" +
	    				"<br> des m̩thode appell̩es avant la lev̩e d'une exception ?","printErrors()","traceStack()","getMessage()","printStackTrace","printStackTrace"),

	            new Qcm("De quel classe la m̩thode toString est h̩rit̩e ?","Objet","Comparable","throwable","Iterable","Objet"),
